...
export default function EditableImage({ link, setLink, folder = 'avatars', width = 120, height = 120 }) {
    ...
    return (
        <div className="relative border border-dashed border-spacing-6 w-[300px] h-[300px] rounded-md overflow-hidden">
            {
                link && (
                    <Image src={link} alt="avatar" className="rounded-md mx-auto mb-1" quality={100} width={width} height={height} />
                )
            }
