...
export default function Table() {
    return (
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border-separate border-spacing-y-1">
            ...
            <tbody>
                <tr className="border-b bg-primary/90 border-primary/90 hover:bg-gray-600">
                    ...
                    <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                        <Image width={50} height={50} className="w-10 h-10 rounded-full" src={'/placeholders/user-placeholder.jpg'} alt="Jese image" />
                        <div className="ps-3">
