    ...
    const handleSubmitSpecs = async () => {
        const createSpecsPromise = new Promise(async (resolve, reject) => {
            ...
            if(selectedSection === 'products') {
                data.productId = selectedItem._id
            } else if(selectedSection === 'categories') {
                data.categoryId = selectedItem._id
            } else {
                data.brandId = selectedItem._id
            }
                                ...
                                !selectedItem ? (
                                    ...
                                    <div className="h-full">
                                        ...
                                        <div className="flex gap-2 mb-2">
                                            ...
                                            <button type="button" onClick={handleAddSpecTitle}>ایجاد عنوان</button>
                                        </div>
